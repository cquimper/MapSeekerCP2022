...
gen_options_lists(X13, col(X16,X14), X17, X9, X10, X12, X1, X11, X15) :- 
    (X13 \== model_seeker ->
        gen_options_lists_by_type(bool,    X13, col(X16,X14), X17, X9, X10, X12, X1, X11),
        gen_value_sets_wrt_boolean_operators(X13, X12, col(X16,X14), [], [], X15)
    ;
        gen_options_lists_by_type(bool,    X13, col(X16,X14), X17, X9, X10, X12, X1, X7),
        gen_options_lists_by_type(cond,    X13, col(X16,X14), X17, X9, X10, X12, X1, X8),
        ((X7 = [], X8 = []) ->
            X15 = []
        ;
            gen_value_sets_wrt_boolean_operators(X13, X12, col(X16,X14), [], [], X15)
        ),
        gen_options_lists_by_type(formula(1,1), X13, col(X16,X14), X17, X9, X10, X12, X1, X2),
        gen_options_lists_by_type(formula(2,2), X13, col(X16,X14), X17, X9, X10, X12, X1, X3),
        gen_options_lists_by_type(formula(3,3), X13, col(X16,X14), X17, X9, X10, X12, X1, X4),
        gen_options_lists_by_type(formula(4,4), X13, col(X16,X14), X17, X9, X10, X12, X1, X5),
        gen_options_lists_by_type(formula(5,5), X13, col(X16,X14), X17, X9, X10, X12, X1, X6),
        append([X7,
                X2,
                X3,
                X8,
